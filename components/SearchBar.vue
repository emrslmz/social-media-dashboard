<template>
  <div class="flex justify-center items-center space-x-3 mt-4 md:mt-0">
    ...
    <button
        ...
        @click="searchAction"
        class="flex items-center justify-center px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200  rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 w-1/3 h-12">
